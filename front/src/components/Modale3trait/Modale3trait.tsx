...
function Modale3trait({datas, userRole, setOpenRejet, setOpenProdDetail, setOpenAdminArticle, setOpenAdminMachine, setOpenHistorique, setOpenAdminUsers}: Modale3traitPros){
  ...
  return (
    <div>
      ...
      <div className="hamburger" onClick={()=>{setOpenModaleSideBar(true)}}>
         <div className="bar" />
         <div className="bar" />
      ...
      {openModaleSideBar && (
        ...
        <div> 
                      ...
                      {/* biome-ignore lint/a11y/useKeyWithClickEvents: <explanation> */}
          <span className='closed' onClick={()=>{setOpenModaleSideBar(false)}}> &times;</span>
